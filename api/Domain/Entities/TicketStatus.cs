...
{
    public enum TicketStatuses { Emmited = 1, OK = 2, VoidPending = 3, Voided = 4, Used = 5, Retry = 6, NotFound = 7, Invalid =8 }
    ...
    public class TicketStatus
    {
        ...
        public static TicketStatus Invalid { get { return new TicketStatus(TicketStatuses.Invalid); } }
